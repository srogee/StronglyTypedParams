            ...
            /// DOF permission
            /// </remarks>
            public OnOff DepthOfFieldEnabled 
            {
                get => (OnOff)CellsByName["DepthOfFieldEnabled"].Value;
                set => CellsByName["DepthOfFieldEnabled"].Value = (byte)value;
            }
            ...
            public int ForceHighResolutionBlur 
            {
                ...
                set => CellsByName["ForceHighResolutionBlur"].Value = (int)value;
            }
            ...
            public int MaximumBlurLevel 
            {
                ...
                set => CellsByName["MaximumBlurLevel"].Value = (int)value;
            }
