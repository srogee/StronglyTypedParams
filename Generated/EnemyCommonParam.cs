...
namespace StronglyTypedParams
{
    public class EnemyCommonParam : ParamRow
    {
        ...
        public int SoundTargetTryApproachTime
        {
            ...
            set => CellsByName["SoundTargetTryApproachTime"].Value = value;
        }
        ...
        public int SearchTargetTryApproachTime
        {
            ...
            set => CellsByName["SearchTargetTryApproachTime"].Value = value;
        }
        ...
        public int MemoryTargetTryApproachTime
        {
            ...
            set => CellsByName["MemoryTargetTryApproachTime"].Value = value;
        }
        ...
        public int ActivateChrByTimePhantomID
        {
            ...
            set => CellsByName["ActivateChrByTimePhantomID"].Value = value;
        }
        ...
        public float FindUnfavourableFailedPointDistance
        {
            ...
            set => CellsByName["FindUnfavourableFailedPointDistance"].Value = value;
        }
        ...
        public float FindUnfavourableFailedPointHeight
        {
            ...
            set => CellsByName["FindUnfavourableFailedPointHeight"].Value = value;
        }
