...
namespace StronglyTypedParams
{
    public class MissileParam : ParamRow
    {
        ...
        public int FFXID
        {
            ...
            set => CellsByName["FFXID"].Value = value;
        }
        ...
        public ushort SurvivalTimeFrame
        {
            ...
            set => CellsByName["SurvivalTimeFrame"].Value = value;
        }
        ...
        public ushort HitBallRadiusCm
        {
            ...
            set => CellsByName["HitBallRadiusCm"].Value = value;
        }
        ...
        public ushort LandingDamage
        {
            ...
            set => CellsByName["LandingDamage"].Value = value;
        }
        ...
        public float InitialSpeedMS
        {
            ...
            set => CellsByName["InitialSpeedMS"].Value = value;
        }
        ...
        public float RangeDistance
        {
            ...
            set => CellsByName["RangeDistance"].Value = value;
        }
        ...
        public float GravityWithinRange
        {
            ...
            set => CellsByName["GravityWithinRange"].Value = value;
        }
        ...
        public float OutOfRangeGravity
        {
            ...
            set => CellsByName["OutOfRangeGravity"].Value = value;
        }
        ...
        public int MPConsumption
        {
            ...
            set => CellsByName["MPConsumption"].Value = value;
        }
        ...
        public float AccelerationWithinRange
        {
            ...
            set => CellsByName["AccelerationWithinRange"].Value = value;
        }
        ...
        public float OutOfRangeAcceleration
        {
            ...
            set => CellsByName["OutOfRangeAcceleration"].Value = value;
        }
        ...
        public ushort LandingID
        {
            ...
            set => CellsByName["LandingID"].Value = value;
        }
        ...
        /// </remarks>
        public byte WillYouDieAtTheEndOfYourLife
        {
            get => (byte)CellsByName["WillYouDieAtTheEndOfYourLife"].Value;
            set => CellsByName["WillYouDieAtTheEndOfYourLife"].Value = value;
        }
        ...
        /// </remarks>
        public byte WillItLandWhenTheLifeHasExpired
        {
            get => (byte)CellsByName["WillItLandWhenTheLifeHasExpired"].Value;
            set => CellsByName["WillItLandWhenTheLifeHasExpired"].Value = value;
        }
        ...
        public int ActionIDOnHit
        {
            ...
            set => CellsByName["ActionIDOnHit"].Value = value;
        }
