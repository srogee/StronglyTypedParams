...
namespace StronglyTypedParams
{
    public class FeTextEffectParam : ParamRow
    {
        ...
        public short ResourceID
        {
            ...
            set => CellsByName["ResourceID"].Value = value;
        }
        ...
        public int SEID
        {
            ...
            set => CellsByName["SEID"].Value = value;
        }
        ...
        /// </remarks>
        public byte DisplaySimultaneouslyWithMapName
        {
            get => (byte)CellsByName["DisplaySimultaneouslyWithMapName"].Value;
            set => CellsByName["DisplaySimultaneouslyWithMapName"].Value = value;
        }
