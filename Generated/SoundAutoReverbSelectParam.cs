            ...
            public uint ReverbType 
            {
                ...
                set => CellsByName["ReverbType"].Value = (uint)value;
            }
            ...
            public int ConditionAreaNumber 
            {
                ...
                set => CellsByName["ConditionAreaNumber"].Value = (int)value;
            }
            ...
            public sbyte ConditionIndoorOutdoor 
            {
                ...
                set => CellsByName["ConditionIndoorOutdoor"].Value = (sbyte)value;
            }
            ...
            public sbyte ConditionEvaluationDistanceA 
            {
                ...
                set => CellsByName["ConditionEvaluationDistanceA"].Value = (sbyte)value;
            }
            ...
            public sbyte ConditionEvaluationDistanceB 
            {
                ...
                set => CellsByName["ConditionEvaluationDistanceB"].Value = (sbyte)value;
            }
            ...
            public float ConditionEvaluationDistanceAMin 
            {
                ...
                set => CellsByName["ConditionEvaluationDistanceAMin"].Value = (float)value;
            }
            ...
            public float ConditionEvaluationDistanceAMax 
            {
                ...
                set => CellsByName["ConditionEvaluationDistanceAMax"].Value = (float)value;
            }
            ...
            public float ConditionEvaluationDistanceBMin 
            {
                ...
                set => CellsByName["ConditionEvaluationDistanceBMin"].Value = (float)value;
            }
            ...
            public float ConditionEvaluationDistanceBMax 
            {
                ...
                set => CellsByName["ConditionEvaluationDistanceBMax"].Value = (float)value;
            }
            ...
            public int ConditionNoHitMinimum 
            {
                ...
                set => CellsByName["ConditionNoHitMinimum"].Value = (int)value;
            }
