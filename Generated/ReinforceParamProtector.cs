            ...
            public float DefencePercentSlash 
            {
                ...
                set => CellsByName["DefencePercentSlash"].Value = (float)value;
            }
            ...
            public float DefencePercentStrike 
            {
                ...
                set => CellsByName["DefencePercentStrike"].Value = (float)value;
            }
            ...
            public float DefencePercentThrust 
            {
                ...
                set => CellsByName["DefencePercentThrust"].Value = (float)value;
            }
            ...
            public byte PassiveSpEffectID1Offset 
            {
                ...
                set => CellsByName["PassiveSpEffectID1Offset"].Value = (byte)value;
            }
            ...
            public byte PassiveSpEffectID2Offset 
            {
                ...
                set => CellsByName["PassiveSpEffectID2Offset"].Value = (byte)value;
            }
            ...
            public byte PassiveSpEffectID3Offset 
            {
                ...
                set => CellsByName["PassiveSpEffectID3Offset"].Value = (byte)value;
            }
            ...
            public byte ReinforcementMaterialSetID 
            {
                ...
                set => CellsByName["ReinforcementMaterialSetID"].Value = (byte)value;
            }
            ...
            public float AuxResistPercentFrost 
            {
                ...
                set => CellsByName["AuxResistPercentFrost"].Value = (float)value;
            }
