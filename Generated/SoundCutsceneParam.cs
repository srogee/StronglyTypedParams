            ...
            public byte ReverbType 
            {
                ...
                set => CellsByName["ReverbType"].Value = (byte)value;
            }
            ...
            /// </remarks>
            public SoundCutsceneBgmBehaviorType BGMBehaviorTypeOnStart 
            {
                get => (SoundCutsceneBgmBehaviorType)CellsByName["BGMBehaviorTypeOnStart"].Value;
                set => CellsByName["BGMBehaviorTypeOnStart"].Value = (short)value;
            }
            ...
            /// </remarks>
            public SoundCutsceneBgmBehaviorType OneShotBGMBehaviorTypeOnStart 
            {
                get => (SoundCutsceneBgmBehaviorType)CellsByName["OneShotBGMBehaviorTypeOnStart"].Value;
                set => CellsByName["OneShotBGMBehaviorTypeOnStart"].Value = (short)value;
            }
            ...
            public int PostPlaySEID 
            {
                ...
                set => CellsByName["PostPlaySEID"].Value = (int)value;
            }
            ...
            public int PostPlaySEIDForSkip 
            {
                ...
                set => CellsByName["PostPlaySEIDForSkip"].Value = (int)value;
            }
            ...
            public float EnterMapMuteStopTimeOnDrawCutscene 
            {
                ...
                set => CellsByName["EnterMapMuteStopTimeOnDrawCutscene"].Value = (float)value;
            }
