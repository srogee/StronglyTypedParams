            ...
            public object MaterialParamName 
            {
                ...
                set => CellsByName["MaterialParamName"].Value = (object)value;
            }
            ...
            public int MaterialID 
            {
                ...
                set => CellsByName["MaterialID"].Value = (int)value;
            }
            ...
            public float MaterialParamValueR 
            {
                ...
                set => CellsByName["MaterialParamValueR"].Value = (float)value;
            }
            ...
            public float MaterialParamValueG 
            {
                ...
                set => CellsByName["MaterialParamValueG"].Value = (float)value;
            }
            ...
            public float MaterialParamValueB 
            {
                ...
                set => CellsByName["MaterialParamValueB"].Value = (float)value;
            }
            ...
            public float MaterialParamValueA 
            {
                ...
                set => CellsByName["MaterialParamValueA"].Value = (float)value;
            }
            ...
            public float MaterialParamValueI 
            {
                ...
                set => CellsByName["MaterialParamValueI"].Value = (float)value;
            }
