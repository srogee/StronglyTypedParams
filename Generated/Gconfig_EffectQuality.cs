            ...
            /// </remarks>
            public OnOff SoftParticlesEnabled 
            {
                get => (OnOff)CellsByName["SoftParticlesEnabled"].Value;
                set => CellsByName["SoftParticlesEnabled"].Value = (byte)value;
            }
            ...
            /// Glow effective
            /// </remarks>
            public OnOff GlowEnabled 
            {
                get => (OnOff)CellsByName["GlowEnabled"].Value;
                set => CellsByName["GlowEnabled"].Value = (byte)value;
            }
            ...
            /// </remarks>
            public OnOff DistortionEnabled 
            {
                get => (OnOff)CellsByName["DistortionEnabled"].Value;
                set => CellsByName["DistortionEnabled"].Value = (byte)value;
            }
            ...
            public byte EnableBilateralUpscale 
            {
                ...
                set => CellsByName["EnableBilateralUpscale"].Value = (byte)value;
            }
            ...
            public float NumberOfEmitsInInstance 
            {
                ...
                set => CellsByName["NumberOfEmitsInInstance"].Value = (float)value;
            }
            ...
            public float EmitInterval 
            {
                ...
                set => CellsByName["EmitInterval"].Value = (float)value;
            }
            ...
            public float _1stLODDistanceScale 
            {
                ...
                set => CellsByName["_1stLODDistanceScale"].Value = (float)value;
            }
            ...
            public float _2ndLODDistanceScale 
            {
                ...
                set => CellsByName["_2ndLODDistanceScale"].Value = (float)value;
            }
            ...
            public float _3rdLODDistanceScale 
            {
                ...
                set => CellsByName["_3rdLODDistanceScale"].Value = (float)value;
            }
            ...
            public float _4thLODDistanceScale 
            {
                ...
                set => CellsByName["_4thLODDistanceScale"].Value = (float)value;
            }
            ...
            public float ScaleRenderDistanceScale 
            {
                ...
                set => CellsByName["ScaleRenderDistanceScale"].Value = (float)value;
            }
