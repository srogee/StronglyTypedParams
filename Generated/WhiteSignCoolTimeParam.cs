            ...
            public float LimitationTimeNormal 
            {
                ...
                set => CellsByName["LimitationTimeNormal"].Value = (float)value;
            }
            ...
            public float LimitationTimeNormalDriedFinger 
            {
                ...
                set => CellsByName["LimitationTimeNormalDriedFinger"].Value = (float)value;
            }
            ...
            public float LimitationTimeGuardian 
            {
                ...
                set => CellsByName["LimitationTimeGuardian"].Value = (float)value;
            }
            ...
            public float LimitationTimeGuardianDriedFinger 
            {
                ...
                set => CellsByName["LimitationTimeGuardianDriedFinger"].Value = (float)value;
            }
