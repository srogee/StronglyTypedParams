...
namespace StronglyTypedParams
{
    public class PerformanceCheckParam : ParamRow
    {
        ...
        public byte ReportDestination_JobTypeTag
        {
            ...
            set => CellsByName["ReportDestination_JobTypeTag"].Value = value;
        }
        ...
        public byte ReportDestination_categoryTag
        {
            ...
            set => CellsByName["ReportDestination_categoryTag"].Value = value;
        }
        ...
        public byte ComparisonSymbol
        {
            ...
            set => CellsByName["ComparisonSymbol"].Value = value;
        }
        ...
        public float ComparisonValue
        {
            ...
            set => CellsByName["ComparisonValue"].Value = value;
        }
        ...
        public object Reservation2
        {
            ...
            set => CellsByName["Reservation2"].Value = value;
        }
        ...
        public object ReportDestination_userTag
        {
            ...
            set => CellsByName["ReportDestination_userTag"].Value = value;
        }
