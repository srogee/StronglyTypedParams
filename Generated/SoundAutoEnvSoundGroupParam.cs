            ...
            public int SoundNumber 
            {
                ...
                set => CellsByName["SoundNumber"].Value = (int)value;
            }
            ...
            public float ExpandRange 
            {
                ...
                set => CellsByName["ExpandRange"].Value = (float)value;
            }
            ...
            public float FollowSpeed 
            {
                ...
                set => CellsByName["FollowSpeed"].Value = (float)value;
            }
            ...
            public float FollowRate 
            {
                ...
                set => CellsByName["FollowRate"].Value = (float)value;
            }
