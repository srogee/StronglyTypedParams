            ...
            public float NoHitDistance 
            {
                ...
                set => CellsByName["NoHitDistance"].Value = value;
            }
            ...
            /// </remarks>
            public byte IncludeCollisionPointOfNoHit 
            {
                get => (byte)CellsByName["IncludeCollisionPointOfNoHit"].Value;
                set => CellsByName["IncludeCollisionPointOfNoHit"].Value = value;
            }
            ...
            /// </remarks>
            public byte IncludeOutdoorCollisionPoint 
            {
                get => (byte)CellsByName["IncludeOutdoorCollisionPoint"].Value;
                set => CellsByName["IncludeOutdoorCollisionPoint"].Value = value;
            }
            ...
            /// </remarks>
            public byte IncludeFloorCollisionPoint 
            {
                get => (byte)CellsByName["IncludeFloorCollisionPoint"].Value;
                set => CellsByName["IncludeFloorCollisionPoint"].Value = value;
            }
            ...
            public byte EvaluationDistanceCalculationType 
            {
                ...
                set => CellsByName["EvaluationDistanceCalculationType"].Value = value;
            }
            ...
            public float InvalidateAfterDuration 
            {
                ...
                set => CellsByName["InvalidateAfterDuration"].Value = value;
            }
            ...
            public uint MaxCollisionPointCount 
            {
                ...
                set => CellsByName["MaxCollisionPointCount"].Value = value;
            }
            ...
            public uint MaxDistanceUntilIgnore 
            {
                ...
                set => CellsByName["MaxDistanceUntilIgnore"].Value = value;
            }
