            ...
            public int EventLayerID 
            {
                ...
                set => CellsByName["EventLayerID"].Value = (int)value;
            }
            ...
            public int MapStudioLayerID 
            {
                ...
                set => CellsByName["MapStudioLayerID"].Value = (int)value;
            }
            ...
            public int PlayRegionIDOffset 
            {
                ...
                set => CellsByName["PlayRegionIDOffset"].Value = (int)value;
            }
            ...
            public int OverrideMapPlaceNameID 
            {
                ...
                set => CellsByName["OverrideMapPlaceNameID"].Value = (int)value;
            }
            ...
            public int OverrideSaveMapNameID 
            {
                ...
                set => CellsByName["OverrideSaveMapNameID"].Value = (int)value;
            }
