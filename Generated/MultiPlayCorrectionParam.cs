            ...
            public int FriendlyClient1SpEffectID 
            {
                ...
                set => CellsByName["FriendlyClient1SpEffectID"].Value = (int)value;
            }
            ...
            public int FriendlyClient2SpEffectID 
            {
                ...
                set => CellsByName["FriendlyClient2SpEffectID"].Value = (int)value;
            }
            ...
            public int FriendlyClient3SpEffectID 
            {
                ...
                set => CellsByName["FriendlyClient3SpEffectID"].Value = (int)value;
            }
            ...
            /// </remarks>
            public MultiPlayCorrectionOverrideType OverrideSpEffectWhenClientCountChanges 
            {
                get => (MultiPlayCorrectionOverrideType)CellsByName["OverrideSpEffectWhenClientCountChanges"].Value;
                set => CellsByName["OverrideSpEffectWhenClientCountChanges"].Value = (byte)value;
            }
