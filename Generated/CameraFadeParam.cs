            ...
            public float ProximityFadeMinimumNearDistance 
            {
                ...
                set => CellsByName["ProximityFadeMinimumNearDistance"].Value = (float)value;
            }
            ...
            public float ProximityFadeMaximumNearDistance 
            {
                ...
                set => CellsByName["ProximityFadeMaximumNearDistance"].Value = (float)value;
            }
            ...
            public float ProximityFadeMinimumFarDistance 
            {
                ...
                set => CellsByName["ProximityFadeMinimumFarDistance"].Value = (float)value;
            }
            ...
            public float ProximityFadeMaximumFarDistance 
            {
                ...
                set => CellsByName["ProximityFadeMaximumFarDistance"].Value = (float)value;
            }
            ...
            public float ProximityFadeAlpha 
            {
                ...
                set => CellsByName["ProximityFadeAlpha"].Value = (float)value;
            }
