            ...
            /// Command type
            /// </remarks>
            public CharmakemenuCmdType CommandType 
            {
                get => (CharmakemenuCmdType)CellsByName["CommandType"].Value;
                set => CellsByName["CommandType"].Value = (int)value;
            }
            ...
            public int FaceParamID 
            {
                ...
                set => CellsByName["FaceParamID"].Value = (int)value;
            }
            ...
            public int TableIDMale 
            {
                ...
                set => CellsByName["TableIDMale"].Value = (int)value;
            }
            ...
            /// </remarks>
            public CharmakemenuViewCondition ViewCondition 
            {
                get => (CharmakemenuViewCondition)CellsByName["ViewCondition"].Value;
                set => CellsByName["ViewCondition"].Value = (int)value;
            }
            ...
            /// </remarks>
            public CharmakemenuPreviewMode PreviewMode 
            {
                get => (CharmakemenuPreviewMode)CellsByName["PreviewMode"].Value;
                set => CellsByName["PreviewMode"].Value = (sbyte)value;
            }
            ...
            public int TableIDFemale 
            {
                ...
                set => CellsByName["TableIDFemale"].Value = (int)value;
            }
            ...
            public int ReferenceFaceParamID 
            {
                ...
                set => CellsByName["ReferenceFaceParamID"].Value = (int)value;
            }
            ...
            public int ReferenceTextID 
            {
                ...
                set => CellsByName["ReferenceTextID"].Value = (int)value;
            }
            ...
            public uint UnlockEventFlagID 
            {
                ...
                set => CellsByName["UnlockEventFlagID"].Value = (uint)value;
            }
